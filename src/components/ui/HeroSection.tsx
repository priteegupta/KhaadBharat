  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <motion.div className="lg:col-span-8 flex flex-col gap-6" variants={textItemVariants}>
          ...
          {/* Success Statistics */}
          <div className="grid grid-cols-3 gap-4 mt-6 border-t border-white/15 pt-6">
            <div className="flex flex-col">
              <span className="text-2xl sm:text-3xl font-black text-brand-accent-sunlight">50,000+</span>
            ...
            <div className="flex flex-col border-l border-white/15 pl-4">
              <span className="text-2xl sm:text-3xl font-black text-brand-accent-sunlight">30%+</span>
              <span className="text-[10px] sm:text-xs font-black text-white/70 uppercase tracking-wider">
                {isHi ? "जल की बचत" : "Water Saved"}
              </span>
            </div>
            <div className="flex flex-col border-l border-white/15 pl-4">
              <span className="text-2xl sm:text-3xl font-black text-brand-accent-sunlight">45%+</span>
              <span className="text-[10px] sm:text-xs font-black text-white/70 uppercase tracking-wider">
